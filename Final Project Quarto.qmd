...
Age: Integer, age Playing.
Hours: Integer, hour participants spent on electronic device Productive.
Time: Integer, hour participants spent on work or study Feel.
After: String: "Good", "Tired", "Unmotivated" Mental.Harm: Catagory: No, Yes
...
4.  Calculate the GAD-7 scores

```{r}
DB2_residence_USA <- database_2 |>
